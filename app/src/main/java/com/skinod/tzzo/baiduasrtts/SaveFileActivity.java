...
import com.skinod.tzzo.baiduasrtts.listener.FileSaveListener;
import com.skinod.tzzo.baiduasrtts.util.FileUtiltts;
...
public class SaveFileActivity extends SynthActivity {
    ...
    protected void initialTts() {
        String tmpDir = FileUtiltts.createTmpDir(this);
        // 设置初始化参数
