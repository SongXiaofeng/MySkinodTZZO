...
public class AudioUtil {
    ...
    public void adjustStreamVolumeUp(int streamType) {
        //减少音量
        mAudioManager.adjustStreamVolume(streamType, AudioManager.ADJUST_RAISE, AudioManager.FX_FOCUS_NAVIGATION_UP);

    }

    public void adjustStreamVolumeDown(int streamType) {
        // 增加电量
        mAudioManager.adjustStreamVolume(streamType, AudioManager.ADJUST_LOWER, AudioManager.FX_FOCUS_NAVIGATION_UP);
    }
}
