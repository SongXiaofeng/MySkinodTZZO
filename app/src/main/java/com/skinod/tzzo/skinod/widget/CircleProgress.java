package com.skinod.tzzo.skinod.widget;
...
public class CircleProgress extends View{
    ...
    private CircleProgressListener circleProgressListener;
  ...
  /*      postDelayed(new Runnable() {
    ...
    public void stop() {
        ...
        invalidate();
        circleProgressListener.circlefinish();
    }
...
//        mRingCenterRadius = Math.min(w, h)+mBorderWidth/2;
  ...
  /*  @Override
    ...
    public void setfinishListener(CircleProgressListener cpl) {
        this.circleProgressListener=cpl;
    }
}
