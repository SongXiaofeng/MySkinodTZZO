...
/*
        if (position == 12) {
            ...
            viewHolder.btnKey.setBackgroundResource(R.mipmap.keyboard_arrwo_left);
        }

        if (position == 14) {
            viewHolder.btnKey.setClickable(false);
            viewHolder.btnKey.setBackgroundResource(R.mipmap.keyboard_arrwo_right);
        }*/
     ...
     /*   if (position == 9) {
            ...
            viewHolder.btnKey.setTextColor(R.drawable.text_choose);
           // viewHolder.btnKey.setBackgroundColor(Color.parseColor("#e0e0e0"));
           // viewHolder.btnKey.setBackgroundResource(R.drawable.enter_tran_press);
        }else */
